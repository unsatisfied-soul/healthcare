...
const About = () => {
    return (
        <div className="aboutus py-24">
            <div className="aboutus-top about w-5/6 mx-auto flex gap-5">
                <div className="top-img w-2/4">
                    <img className="w-full h-full" src="https://i.ibb.co/KXj3Dxt/pexels-rodnae-productions-6129507.jpg" alt="" />
                </div>
            ...
            <div className="aboutus-bottom about flex gap-5 w-5/6 mx-auto py-24">
